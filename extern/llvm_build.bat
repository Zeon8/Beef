...
cmake ../llvm-project_22_1_5/llvm -G Ninja -DLLVM_ENABLE_PROJECTS="clang;lldb" -G"Visual Studio 18 2026" -Ax64 -Thost=x64 -D CMAKE_MSVC_RUNTIME_LIBRARY="MultiThreaded$<$<CONFIG:Debug>:Debug>" -DLLVM_TARGETS_TO_BUILD="AArch64;ARM;X86;WebAssembly;Mips"
